...
public class GitHubCommentService {
     ...
     * UPDATED: Now uses installation token if available
     */
    ...
    public boolean postInlineComment(String owner, String repo, int prNumber,
        ...
        try {
            ...
            if (success) {
                log.info("✅ Posted inline comment on line {}", issue.getLineNumber());
            } else {
                log.warn("⚠️ Failed to post inline comment: {}", response.getStatusCode());
            }
